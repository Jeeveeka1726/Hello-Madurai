...
function VideosPageContent() {
  ...
  const handleWhatsAppShare = async (video: Video) => {
    ...
    // Open WhatsApp directly - Use location.href for iOS compatibility
    const whatsappUrl = `https://wa.me/?text=${encodeURIComponent(shareText)}`

    // For iOS Safari compatibility - use location.href instead of window.open
                    ...
                    <CardContent className="p-3 sm:p-4 flex flex-col flex-grow">
                      ...
                      <div className="flex gap-2 mt-auto">
                        ...
                        <button
                          ...
                          className="flex-1 min-w-0 bg-green-500 hover:bg-green-600 active:bg-green-700 active:scale-95 text-white font-medium py-2.5 px-2 sm:px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 shadow-sm hover:shadow-md min-h-[44px]"
                        ...
                        >
                          ...
                          <span className="hidden sm:inline text-xs font-semibold whitespace-nowrap truncate" suppressHydrationWarning>WhatsApp</span>
                        </button>

                        {/* Facebook Share */}
                        <button
                          onClick={() => handleFacebookShare(video)}
                          className="flex-1 min-w-0 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-95 text-white font-medium py-2.5 px-2 sm:px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 shadow-sm hover:shadow-md min-h-[44px]"
                        ...
                        >
                          ...
                          <span className="hidden sm:inline text-xs font-semibold whitespace-nowrap truncate" suppressHydrationWarning>Facebook</span>
                        </button>

                        {/* Copy Link */}
                        <button
                          onClick={() => handleCopyLink(video)}
                          className="flex-1 min-w-0 bg-gray-600 hover:bg-gray-700 active:bg-gray-800 active:scale-95 text-white font-medium py-2.5 px-2 sm:px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 shadow-sm hover:shadow-md min-h-[44px]"
                          title="Copy Link"
                        ...
                        >
                          ...
                          <span className="hidden sm:inline text-xs font-semibold whitespace-nowrap truncate" suppressHydrationWarning>
