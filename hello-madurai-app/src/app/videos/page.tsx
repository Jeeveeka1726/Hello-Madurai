      ...
      return (
        <div key={`ad-${ad.id}-${index}`} className="col-span-full my-8">
          <div className="p-4 sm:p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border-2 border-blue-400 shadow-lg">
            ...
            {/* Stats at bottom - single line */}
            <div className="flex items-center justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-blue-600 mt-4 pt-3 border-t border-blue-200">
              <div className="flex items-center gap-1.5">
                <EyeIcon className="h-4 w-4 sm:h-5 sm:w-5" />
                <span className="font-medium">{ad.impressions.toLocaleString()}</span>
                <span className="text-blue-500">{language === 'ta' ? 'பார்வைகள்' : 'views'}</span>
              </div>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-blue-500">{language === 'ta' ? 'கிளிக்குகள்' : 'clicks'}</span>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <CardContent className="p-3 sm:p-4 flex flex-col flex-grow">
                      ...
                      <div className="flex gap-1.5 sm:gap-2 mt-auto">
                        ...
                        <button
                          ...
                          className="flex-1 bg-green-500 hover:bg-green-600 active:bg-green-700 active:scale-95 text-white font-medium py-2.5 sm:py-3 px-1.5 sm:px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 shadow-sm hover:shadow-md min-h-[44px]"
                        ...
                        >
                          ...
                          <span className="hidden sm:inline text-xs sm:text-sm font-semibold whitespace-nowrap" suppressHydrationWarning>WhatsApp</span>
                        </button>

                        {/* Facebook Share */}
                        <button
                          onClick={() => handleFacebookShare(video)}
                          className="flex-1 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-95 text-white font-medium py-2.5 sm:py-3 px-1.5 sm:px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 shadow-sm hover:shadow-md min-h-[44px]"
                        ...
                        >
                          ...
                          <span className="hidden sm:inline text-xs sm:text-sm font-semibold whitespace-nowrap" suppressHydrationWarning>Facebook</span>
                        </button>

                        {/* Copy Link */}
                        <button
                          onClick={() => handleCopyLink(video)}
                          className="flex-1 bg-gray-600 hover:bg-gray-700 active:bg-gray-800 active:scale-95 text-white font-medium py-2.5 sm:py-3 px-1.5 sm:px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 shadow-sm hover:shadow-md min-h-[44px]"
                          title="Copy Link"
                        ...
                        >
                          ...
                          <span className="hidden sm:inline text-xs sm:text-sm font-semibold whitespace-nowrap" suppressHydrationWarning>
