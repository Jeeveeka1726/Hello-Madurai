...
function VideosPageContent() {
  ...
  const handleWhatsAppShare = async (video: Video) => {
    ...
    // Open WhatsApp directly - WhatsApp will fetch thumbnail from Open Graph meta tags
  ...
  const handleFacebookShare = async (video: Video) => {
    ...
    // Open Facebook sharer - Facebook will fetch thumbnail from Open Graph meta tags
        ...
        <div className="mb-4 sm:mb-6 md:mb-8">
          <div className="relative max-w-2xl mx-auto">
            <input
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-3 pl-10 sm:pl-12 pr-3 sm:pr-4 text-sm sm:text-base text-gray-900 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
                ...
                <>
                  <Card key={video.id} className="overflow-hidden hover:shadow-xl transition-all bg-white border-gray-200">
                    ...
                    <CardContent className="p-3 sm:p-4 md:p-5">
                      {/* Title - Clickable */}
                      <h3
                        className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2 sm:mb-3 md:mb-4 line-clamp-2 cursor-pointer hover:text-blue-600 transition-colors"
                        suppressHydrationWarning
                      ...
                      <div className="flex items-center justify-between mb-2 sm:mb-3 md:mb-4">
                        <span className="inline-block px-2 py-1 text-xs md:text-sm font-medium text-blue-600 bg-blue-100 rounded">
                          {videoCategories.find(c => c.id === video.category)?.[language === 'ta' ? 'name_ta' : 'name'] || video.category}
                        </span>

                        <div className="flex items-center space-x-2 text-xs sm:text-sm text-gray-500">
                          <div className="flex items-center">
                            <EyeIcon className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 mr-1" />
                            <span>{video.views}</span>
                          </div>
                          {video.duration && (
                            <div className="flex items-center">
                              <ClockIcon className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 mr-1" />
                      ...
                      <div className="flex gap-1.5 sm:gap-2 md:gap-2.5">
                        ...
                        <button
                          ...
                          className="flex-1 bg-green-500 hover:bg-green-600 active:bg-green-700 active:scale-95 text-white font-medium py-2.5 sm:py-3 md:py-3.5 px-1.5 sm:px-3 md:px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-2 shadow-sm hover:shadow-md min-h-[44px]"
                          title="Share on WhatsApp"
                          aria-label="Share on WhatsApp"
                        >
                          <svg className="h-4 w-4 sm:h-5 sm:w-5 md:h-5 md:w-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                          ...
                          <span className="hidden sm:inline text-xs sm:text-sm md:text-sm font-semibold" suppressHydrationWarning>WhatsApp</span>
                        </button>

                        {/* Facebook Share */}
                        <button
                          onClick={() => handleFacebookShare(video)}
                          className="flex-1 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-95 text-white font-medium py-2.5 sm:py-3 md:py-3.5 px-1.5 sm:px-3 md:px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-2 shadow-sm hover:shadow-md min-h-[44px]"
                        ...
                        >
                          ...
                          <span className="hidden sm:inline text-xs sm:text-sm md:text-sm font-semibold" suppressHydrationWarning>Facebook</span>
                        </button>

                        {/* Copy Link */}
                        <button
                          onClick={() => handleCopyLink(video)}
                          className="flex-1 bg-gray-600 hover:bg-gray-700 active:bg-gray-800 active:scale-95 text-white font-medium py-2.5 sm:py-3 md:py-3.5 px-1.5 sm:px-3 md:px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 md:gap-2 shadow-sm hover:shadow-md min-h-[44px]"
                          title="Copy Link"
                          aria-label="Copy Link"
                        >
                          <svg className="h-4 w-4 sm:h-5 sm:w-5 md:h-5 md:w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                          </svg>
                          <span className="hidden sm:inline text-xs sm:text-sm md:text-sm font-semibold" suppressHydrationWarning>
