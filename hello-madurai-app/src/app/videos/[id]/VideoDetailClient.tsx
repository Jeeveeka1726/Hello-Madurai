            ...
            <CardContent className="p-4 sm:p-6">
              ...
              <div className="flex gap-2 sm:gap-3">
                <button
                  ...
                  className="flex-1 bg-green-500 hover:bg-green-600 active:bg-green-700 active:scale-95 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-95 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
                >
                  <svg className="h-5 w-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="flex-1 bg-gray-600 hover:bg-gray-700 active:bg-gray-800 active:scale-95 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
                >
                  <svg className="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                  <span className="text-sm font-semibold">{language === 'ta' ? 'நகல்' : 'Copy'}</span>
                </button>
              </div>
            </CardContent>
          </Card>
