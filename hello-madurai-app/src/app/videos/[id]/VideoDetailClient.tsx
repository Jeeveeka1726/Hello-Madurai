            ...
            <CardContent className="p-4 sm:p-6">
              ...
              <div className="flex gap-2 sm:gap-3">
                <button
                  ...
                  className="flex-1 min-w-0 bg-green-500 hover:bg-green-600 active:bg-green-700 active:scale-95 text-white font-medium py-3 px-3 sm:px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 shadow-sm hover:shadow-md min-h-[44px]"
                >
                  ...
                  <span className="text-xs sm:text-sm font-semibold whitespace-nowrap truncate">WhatsApp</span>
                </button>

                <button
                  onClick={handleFacebookShare}
                  className="flex-1 min-w-0 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-95 text-white font-medium py-3 px-3 sm:px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 shadow-sm hover:shadow-md min-h-[44px]"
                >
                  <svg className="h-5 w-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                  <span className="text-xs sm:text-sm font-semibold whitespace-nowrap truncate">Facebook</span>
                </button>

                <button
                  onClick={handleCopyLink}
                  className="flex-1 min-w-0 bg-gray-600 hover:bg-gray-700 active:bg-gray-800 active:scale-95 text-white font-medium py-3 px-3 sm:px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 shadow-sm hover:shadow-md min-h-[44px]"
                >
                  <svg className="h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                  <span className="text-xs sm:text-sm font-semibold whitespace-nowrap truncate">{language === 'ta' ? 'நகல்' : 'Copy'}</span>
                </button>
              </div>
            </CardContent>
          </Card>
