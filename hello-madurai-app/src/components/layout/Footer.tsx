          ...
          <div className="text-center">
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <a
                ...
                className="bg-white hover:bg-blue-50 rounded-lg p-3 transition-all duration-200 hover:scale-110"
                aria-label="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white hover:bg-pink-50 rounded-lg p-3 transition-all duration-200 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white hover:bg-red-50 rounded-lg p-3 transition-all duration-200 hover:scale-110"
                aria-label="YouTube"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white hover:bg-gray-50 rounded-lg p-3 transition-all duration-200 hover:scale-110"
                aria-label="Twitter"
              >
